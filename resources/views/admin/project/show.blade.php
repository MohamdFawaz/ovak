    ...
    <div class="content-wrapper">
        ...
        <div class="card container">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Show {{$property->name}} Project</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('project.update',$property->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select id="districtId" readonly class="form-control select" name="district_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required readonly name="google_map_link" class="form-control" id="area"
                                   value="{{$property->google_map_link}}"
                                   placeholder="Enter Google Map Link">
                        </div>
                        <div class="form-group">
                            <label for="deliveryDate">Delivery Date</label>
                            <input type="date" readonly  value="{{$property->delivery_date}}" required name="delivery_date" class="form-control" id="deliveryDate">
                        </div>
                        <div class="form-group">
                        ...
                        @foreach($utilities as $utility)
                            <div class="form-check">
                                <input disabled @if($property->utility->where('utility_id',$utility->id)->first()) checked @endif type="checkbox" class="form-check-input clearfix" value="{{$utility->id}}" name="utilities[]">
