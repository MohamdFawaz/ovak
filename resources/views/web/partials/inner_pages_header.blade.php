<div class="secondry-page-header">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a href="{{url('/')}}">{{__('front.header.home')}}</a></li>
                    <li class="nav-item"><a @if(strpos(\Request::url(),'projects')) class="active" @endif href="{{route('projects.list')}}">{{__('front.header.projects')}}</a></li>
                    <li class="nav-item"><a @if(strpos(\Request::url(),'developers')) class="active" @endif href="{{route('developers.list')}}">{{__('front.header.developers')}}</a></li>
                    <li class="nav-item"><a @if(strpos(\Request::url(),'about')) class="active" @endif href="{{route('about')}}">{{__('front.header.about_contact')}}</a></li>
                    <li class="nav-item"><a @if(strpos(\Request::url(),'consultancy')) class="active" @endif href="{{route('consultancy')}}">{{__('front.header.consultancy')}}</a></li>
                </ul>
                ...
                <div class="mobile-header-logo">
                    <div class="row">
                        ...
                        <div class="col-6 social-links">
                            ...
                            <a href="{{config('settings.instagram_link')}}" target="_blank" class="col-sm-3 instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a>
