            ...
            <div class="ovarlay">
                ...
                <div class="menu">
                    <div class="logo col-md-2 col-sm-3 col-xs-5">
                        <a href="./index.html"><img src="{{asset('images/Logo.png')}}" class="image-full-width" alt="" /></a>
                    </div>
    ...
    <section class="projects">
        <div class="col-sm-12 no-padding-xs">
            <div class="col-md-4 col-md-push-1 col-sm-8 col-sm-push-1 col-xs-12 no-padding-xs">
                ...
                <div class="clearfix"></div>
                <h2 class="section-second-header"><span class="col-lg-5 col-md-8 col-sm-5 col-xs-5">projects</span> <span class="header-line col-lg-push-1 col-md-2 col-sm-1 col-xs-1 no-padding"></span></h2>
                <div class="clearfix"></div>
    ...
    <section class="subscription">
        <div class="col-sm-12">
            <div class="col-md-6 col-md-push-1 col-sm-6 margin-top-100">
                <h2 class="section-second-header header-letter-spacing"><span class="col-lg-5 col-md-7 col-sm-10 col-xs-8 no-padding">subscripe</span><span class="header-line col-sm-1 col-xs-1 no-padding"></span></h2>
                <div class="clearfix"></div>
    ...
    <section class="developers">
        <div class="col-sm-12 no-padding-xs">
            <div class="col-lg-4 col-lg-push-1 col-md-6 col-md-push-1 col-sm-8 col-xs-12 no-padding-xs">
                <h2 class="section-first-header"><span class="col-md-6 col-sm-6 col-xs-7">projects</span> <span class="header-line col-md-1 col-sm-1 col-xs-2"></span></h2>
                <div class="clearfix"></div>
        ...
        <div class="variable slider">
            <div class="slider-item">
                <div class="slider-image">
                    <img src="resources/assets/images/palmhills.png" alt=""/>
                </div>
            </div>
            <div class="slider-item">
                <div class="slider-image ">
                    <img src="resources/assets/images/palmhills-1.png" alt=""/>
                </div>
            </div>
            <div class="slider-item">
                <div class="slider-image">
                    <img src="resources/assets/images/sodic-1.png" alt=""/>
                </div>
            </div>
            <div class="slider-item">
                <div class="slider-image">
            ...
            <div class="slider-item">
                <div class="slider-image">
                    <img src="resources/assets/images/elmorshedy.png" alt=""/>
                </div>
            </div>
            <div class="slider-item">
                <div class="slider-image">
            ...
            <div class="slider-item">
                <div class="slider-image">
                    <img src="resources/assets/images/talat-group.png" alt=""/>
                </div>
            </div>
            <div class="slider-item">
                <div class="slider-image">
